<?php
  ...
  $randomBackground = "img/sea.jpg"; //original background
...
<html>
    ...
    <body>
        ...
        <form method="get">
            ...
            <input type="text" name="keyword" size="8" placeholder="Keyword" value="<?=$_GET["keyword"]?>" class="keyword"/>
            ...
            <br><br>
            <input type="submit" name="submitBtn" value="Submit" class="sumbit" class="submit"/>
        </form>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            ...
            for ($i=0; $i < 10; $i++) {
               ...
               echo ($i == 0)?" active ":"";//echo many statements
               echo "'>";
